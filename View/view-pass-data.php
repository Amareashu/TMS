...
<head>
    ...
    <title>view passnger data</title>
    <style>
        label {
            font-size: 20px;
        }
        ...
        <div class="row" style="margin-left: 0.5%; margin-right: 0.5%;">
            ...
            <div class="div2 row col-lg-6 rounded  rounded bg-secondary"  id="body" style="font-family: 'Times New Roman', Times, serif;">
                ...
                <div class="form-group">
                    <hr>
                    <h3 class="text-center rounded"><?php echo htmlspecialchars($lang['view-pass-data']); ?></h3>
                    <hr>
                    <div class="input-group mb-3 table-responsive">
                        <table class="table table-bordered table-sm">
                            ...
                            $result = $conn->query("SELECT * FROM `reserved_journey` limit $start_from, $num_per_page");
                            ...
                            <tr style="text-align: center;">
                                <td colspan="10">
                                    ...
                                    $pr_query = "SELECT * FROM `reserved_journey` ";
                                    ...
                                    if ($page > 1) {
                                        echo "<a href='http://localhost/TMS/view/view-pass-data.php?page=" . ($page - 1) . "' class='btn btn-danger'>Previous </a>";
                                    }

                                    for ($i = 1; $i < $total_page; $i++) {
                                        echo "<a href='http://localhost/TMS/view/view-pass-data.php?page=" . $i . "' class='btn btn-primary'>$i</a>";
                                    }

                                    if ($i > $page) {
                                        echo "<a href='http://localhost/TMS/view/view-pass-data.php?page=" . ($page + 1) . "' class='btn btn-danger'> Next</a>";
                                    }

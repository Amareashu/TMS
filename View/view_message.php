        ...
        <div class="row" style="margin-left: 0.5%; margin-right: 0.5%;">
            ...
            <div class="div2 row col-lg-6 rounded  rounded bg-secondary" id="body" style="font-family: 'Times New Roman', Times, serif;">
                <div class="form-group">
                    ...
                    $result = $conn->query("SELECT * FROM `comment` WHERE  `id`='$_GET[c_id]'");
                    $conn->query("UPDATE  `comment` SET `status`='View' WHERE  `id`='$_GET[c_id]'");
                    ...
                    <div class='alert alert-success'>
                        <strong><?php echo htmlspecialchars($lang['email']); ?> : </strong> <?php print $email ?>
                    </div>
                    <div class='alert alert-success'>
                    ...
                    <div class='text-center'>
                        ...
                        <a href='http://localhost/TMS/view/message.php?'><button class='btn-info rounded'>
